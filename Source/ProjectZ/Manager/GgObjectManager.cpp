...
void FGgObjectManager::Clear()
{
	...
	SpawnerList.Empty();
	SpawnerMap.Empty();
	PendingRemovalFoliageMap.Empty();
}
...
//// @brief  폴리지 제거 예약한다.
/////////////////////////////////////////////////////////////////////////////////////////////////////
void FGgObjectManager::ReserveRemoveFoliage( UInstancedStaticMeshComponent* InISMC, int32 InIdx )
{
	PendingRemovalFoliageMap.FindOrAdd( InISMC ).Add( InIdx );
}

/////////////////////////////////////////////////////////////////////////////////////////////////////
//// @brief  제거 예약된 폴리지를 제거한다.
/////////////////////////////////////////////////////////////////////////////////////////////////////
void FGgObjectManager::ProcessFoliageRemove()
{
	if( PendingRemovalFoliageMap.IsEmpty() ) return;

	for( auto& [ ISMC, idxArray ] : PendingRemovalFoliageMap )
	{
		if( ISMC )
		{
			// Note : 소팅하여 뒤에 있는 인덱스를 먼저 제거해야 재배열할때 안꼬인다.
			ISMC->RemoveInstances( idxArray, false );
		}
	}
